...
console.log(`${GREEN}`);
console.log('╔═══════════════════════════════════════════════════════════════╗');
console.log('║         Claude Reconstruction v5.3 - Verify (Node.js)         ║');
console.log('╚═══════════════════════════════════════════════════════════════╝');
console.log(`${NC}`);
...
verifyDir(path.join(CLAUDE_DIR, 'rules', 'evomap'), 'rules/evomap/');
...
verifyFile(path.join(CLAUDE_DIR, 'rules', 'evomap', 'evomap-guide.md'), 'evomap/evomap-guide.md');
console.log('');
...
if (errorCount === 0) {
  ...
  console.log(`${YELLOW}Version:${NC} 5.3 (Context Engineering)`);
  process.exit(0);
} else {
  console.log(`${RED}✗ ${errorCount} check(s) failed.${NC}`);
  console.log('');
  console.log('Run: pnpm install:config');
  process.exit(1);
}
